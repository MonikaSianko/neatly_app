...
export const STR = {
  pl: {
    ...
    paidSection: "Opłacone", sortBy: "Sortuj", sortByDate: "Termin płatności", sortByAdded: "Data dodania",
    sortDirection: "Kierunek sortowania", sortOldest: "Od najstarszych", sortNewest: "Od najnowszych",
    dueDate: "Termin", addedDate: "Dodano", details: "Szczegóły",
    searchCategory: "Szukaj kategorii…", noResults: "Brak wyników",
    searchPayments: "Szukaj po nazwie lub kwocie…", clearSearch: "Wyczyść wyszukiwanie",
    filteredCount: "Znaleziono", ofPayments: "z",
    ...
    refundToggle: "Zwrot do płatności", refundOne: "Zwrot",
    refundHint:
      "Zwrot to przychód doklejony do konkretnego wydatku: pomniejsza tę kategorię zamiast podbijać przychody. Kupiłaś obiad za dwoje, koleżanka oddała połowę — na jedzenie na mieście poszła tylko różnica.",
    refundPick: "Zwracana płatność", refundPickPlaceholder: "Wskaż płatność",
    refundPickTitle: "Wybierz płatność", refundSearchPayment: "Szukaj płatności…",
    refundNoTargets: "Brak wydatków w tym portfelu z ostatniego roku — najpierw dodaj płatność, której dotyczy zwrot.",
    refundCategoryFrom: "Kategoria i tak bierze się z wybranej płatności.",
    refundNoTarget: "Wskaż płatność, której dotyczy zwrot.",
    refundOrphan: "Zwracana płatność została usunięta.",
    refundNoRepeat: "Zwrot dotyczy jednej płatności, więc nie bywa cykliczny.",
    loading: "Wczytywanie…",
    ...
    incomeInfo:
      "Wszystko, co w tym miesiącu wpływa na konto — wypłaty, przelewy, prezenty. Także pozycje z przyszłą datą, jeszcze nieotrzymane. Bez zwrotów doklejonych do płatności: te pomniejszają wydatki swojej kategorii.",
    plannedExpensesInfo:
  ...
  en: {
    ...
    paidSection: "Paid", sortBy: "Sort", sortByDate: "Due date", sortByAdded: "Date added",
    sortDirection: "Sort direction", sortOldest: "Oldest first", sortNewest: "Newest first",
    dueDate: "Due", addedDate: "Added", details: "Details",
    searchCategory: "Search categories…", noResults: "No results",
    searchPayments: "Search by name or amount…", clearSearch: "Clear search",
    filteredCount: "Found", ofPayments: "of",
    ...
    refundToggle: "Refund of a payment", refundOne: "Refund",
    refundHint:
      "A refund is income pinned to one expense: it takes that category down instead of pushing income up. You paid for lunch for two and a friend gave half back — only the difference went on eating out.",
    refundPick: "Payment refunded", refundPickPlaceholder: "Pick a payment",
    refundPickTitle: "Choose a payment", refundSearchPayment: "Search payments…",
    refundNoTargets: "No expenses in this wallet over the last year — add the payment first, then the refund.",
    refundCategoryFrom: "The category comes from the payment you pick.",
    refundNoTarget: "Pick the payment this refund belongs to.",
    refundOrphan: "The refunded payment was deleted.",
    refundNoRepeat: "A refund belongs to a single payment, so it is never recurring.",
    loading: "Loading…",
    ...
    incomeInfo:
      "Everything landing in the account this month — pay, transfers, gifts. Including entries dated later that haven't arrived yet. Refunds pinned to a payment stay out: those take their own category's spending down.",
    plannedExpensesInfo:
